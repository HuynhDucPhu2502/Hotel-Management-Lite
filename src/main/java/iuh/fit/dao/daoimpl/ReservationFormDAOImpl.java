...
public class ReservationFormDAOImpl extends UnicastRemoteObject implements ReservationFormDAO {


    public ReservationFormDAOImpl() throws RemoteException {
    }

    @Override
    public String createReservationForm(ReservationForm form) {
...
//    }
    ...
    @Override
    public List<ReservationForm> getUpcomingReservations(String roomID) {
        EntityManager em = EntityManagerUtil.getEntityManager();
    ...
    @Override
    public List<ReservationForm> getReservationFormByCustomerID(String customerID) {
        EntityManager em = EntityManagerUtil.getEntityManager();
        TypedQuery<ReservationForm> query = em.createQuery("""
                SELECT rf FROM ReservationForm rf
    ...
    @Override
    public List<ReservationForm> getReservationsWithinLastMonth(String roomID) {
        EntityManager em = EntityManagerUtil.getEntityManager();
    ...
    @Override
    public ReservationForm getDataByID(String id) {
        EntityManager em = EntityManagerUtil.getEntityManager();
    ...
    @Override
    public void updateData(ReservationForm form) {
        EntityManager em = EntityManagerUtil.getEntityManager();
        em.getTransaction().begin();
        em.merge(form);
        em.getTransaction().commit();
