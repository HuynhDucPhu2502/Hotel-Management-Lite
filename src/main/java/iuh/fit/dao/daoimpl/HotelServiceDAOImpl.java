...
public class HotelServiceDAOImpl extends UnicastRemoteObject implements HotelServiceDAO {

    public HotelServiceDAOImpl() throws RemoteException {
    }
    ...
    @Override
    public HotelService getDataByID(String hotelServiceId) {
        try (EntityManager em = EntityManagerUtil.getEntityManager()) {
            TypedQuery<HotelService> query = em.createQuery(
                    """
                    SELECT hs FROM HotelService hs
    ...
    @Override
    public boolean createData(HotelService hotelService) {
        try (EntityManager em = EntityManagerUtil.getEntityManager()) {
    ...
    @Override
    public boolean deleteData(String hotelServiceId) {
        try (EntityManager em = EntityManagerUtil.getEntityManager()) {
            em.getTransaction().begin();
    ...
    @Override
    public boolean updateData(HotelService hotelService) {
        try (EntityManager em = EntityManagerUtil.getEntityManager()) {
            em.getTransaction().begin();
    ...
    @Override
    public List<HotelService> findDataByContainsId(String input) {
        try (EntityManager em = EntityManagerUtil.getEntityManager()) {
            TypedQuery<HotelService> query = em.createQuery(
                    """
                    SELECT hs FROM HotelService hs 
    ...
    @Override
    public String getNextHotelServiceID() {
        try (EntityManager em = EntityManagerUtil.getEntityManager()) {
