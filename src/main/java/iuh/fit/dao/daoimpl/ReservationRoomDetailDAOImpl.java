 ...
 * Admin 4/16/2025
 **/
public class ReservationRoomDetailDAOImpl extends UnicastRemoteObject implements ReservationRoomDetailDAO {
    public ReservationRoomDetailDAOImpl() throws RemoteException {
    }

    @Override
    public List<ReservationRoomDetail> getAll() {
    ...
    @Override
    public List<ReservationRoomDetail> getByReservationFormID(String reservationFormID) {
        EntityManager em = EntityManagerUtil.getEntityManager();
    ...
    @Override
    public void createData(ReservationRoomDetail detail) {
        EntityManager em = EntityManagerUtil.getEntityManager();
    ...
    @Override
    public String roomCheckingIn(String reservationFormID, String employeeID) {
        EntityManager em = EntityManagerUtil.getEntityManager();
    ...
    @Override
    public String roomEarlyCheckingIn(String reservationFormID, String employeeID) {
        EntityManager em = EntityManagerUtil.getEntityManager();
        LocalDateTime now = LocalDateTime.now();
