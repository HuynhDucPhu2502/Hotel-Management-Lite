...
public class RoomDisplayOnTableDAOImpl extends UnicastRemoteObject implements RoomDisplayOnTableDAO {

    public RoomDisplayOnTableDAOImpl() throws RemoteException {
    }

    @Override
    public List<RoomDisplayOnTable> getAllData(){
    ...
    @Override
    public List<RoomDisplayOnTable> getDataThreeYearsLatest(){
        List<RoomDisplayOnTable> data = new ArrayList<>();
        String SqlQuery = "SELECT " +
                "r.room_id, " +
                "rc.room_category_name, " +
